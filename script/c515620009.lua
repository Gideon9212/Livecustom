...
function c515620009.initial_effect(c)
...
--control
	...
	e1:SetCondition(c515620009.condition)
	e1:SetCost(c515620009.cost)
	e1:SetTarget(c515620009.target)
	e1:SetOperation(c515620009.operation)
	c:RegisterEffect(e1)
--cannot target
...
c515620009.xyz_number=11
function c515620009.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,80117527)
end
function c515620009.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c515620009.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c515620009.operation(e,tp,eg,ep,ev,re,r,rp)
	local ct=e:GetLabel()
