--Cyber Dragon Vier
--Because Cydras Deserve a chance at being great again!!!
--While you control a Level/Rank 5 monster(s) on your side of the field and 
--all other monsters you control are Machine: You can Special Summon this card from
--your hand. If this card is Special Summoned, you cannot Normal or Special Summon 
--monsters for the rest of this turn except LIGHT monsters. You can target 1 Rank 5
--monster you control; move it to another zone. This card’s name becomes “Cyber 
--Dragon” while it is on the field or in the GY. An Xyz Monster that was Summoned 
--using this card on the field as Xyz material gains this effect: Once while 
--face-up on the field (Quick Effect): Target one Xyz monster on the field; 
--move it to another of the controller’s unoccupied Main or Extra Deck Monster 
--Zones. You can only use each effect of “Cyber Dragon Vier” once per turn
function c210555555.initial_effect(c)
  ...
  e3:SetDescription(aux.Stringid(210555555,0))
...
function c210555555.spcon(e,c)
 ...
 return Duel.IsExistingMatchingCard(c210555555.spfilter,c:GetControler(),LOCATION_MZONE,0,1,nil) and not Duel.IsExistingMatchingCard(c210555555.spfilter2,c:GetControler(),LOCATION_MZONE,0,1,nil) 
end
--summon restriction 
...
function c210555555.efop(e,tp,eg,ep,ev,re,r,rp)
  ...
  e1:SetDescription(aux.Stringid(210555555,1))
