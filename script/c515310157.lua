...
--AlphaKretin
function c515310157.initial_effect(c)
	--xyz summon
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c515310157.matcon)
	e3:SetCost(c515310157.rmcost)
	e3:SetTarget(c515310157.rmtg)
	e3:SetOperation(c515310157.rmop)
	c:RegisterEffect(e3)
	--remove deck
	...
	e4:SetCondition(c515310157.matcon)
	e4:SetCost(c515310157.dkcost)
	e4:SetTarget(c515310157.dktg)
	e4:SetOperation(c515310157.dkop)
	c:RegisterEffect(e4)
end
function c515310157.val(e,c)
	return Duel.GetMatchingGroupCount(Card.IsFacedown,0,LOCATION_REMOVED,LOCATION_REMOVED,nil)*300
end
function c515310157.matcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,95474755)
end
function c515310157.rmcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c515310157.rmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c515310157.rmop(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetChainInfo(0,CHAININFO_TARGET_CARDS):Filter(Card.IsRelateToEffect,nil,e)
	Duel.Remove(g,POS_FACEDOWN,REASON_EFFECT)
end
function c515310157.dkcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c515310157.dktg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c515310157.dkop(e,tp,eg,ep,ev,re,r,rp)
	local num=Duel.GetFieldGroup(tp,0,LOCATION_REMOVED):FilterCount(Card.IsFacedown,nil)
	local g=Duel.GetDecktopGroup(1-tp,num)
	Duel.Remove(g,POS_FACEDOWN,REASON_EFFECT)
end