...
function c515310009.discon(e,tp,eg,ep,ev,re,r,rp)
	local loc=Duel.GetChainInfo(ev,CHAININFO_TRIGGERING_LOCATION)
	return re:IsActiveType(TYPE_MONSTER) and (loc==LOCATION_GRAVE or loc==LOCATION_REMOVED) and Duel.IsExistingMatchingCard(c515310009.filter1,tp,LOCATION_MZONE,0,3,nil)
end
