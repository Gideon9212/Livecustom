...
function c515958932.initial_effect(c)
	...
	e1:SetCondition(c515958932.penconn)
	e1:SetTarget(c515958932.pentgg)
	e1:SetOperation(c515958932.penopp)
	c:RegisterEffect(e1)
	...
	e2:SetCondition(c515958932.pensetcon)
	e2:SetTarget(c515958932.pensettg)
	e2:SetOperation(c515958932.pensetop)
	c:RegisterEffect(e2)	
...
function c515958932.penff2(c,self)
    if c:IsCode(c,515958932) and c:GetFieldID()==self then 
    return c end
end
function c515958932.pentgg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g1=Duel.SelectTarget(tp,c515958932.penff2,tp,LOCATION_HAND,0,1,1,nil,self)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
...
--Set to scale when destroyed
function c515958932.pensetcon(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(r,REASON_EFFECT+REASON_BATTLE)~=0
end
function c515958932.pensettg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLocation(tp,LOCATION_SZONE,6) or Duel.CheckLocation(tp,LOCATION_SZONE,7) end
end
function c515958932.pensetop(e,tp,eg,ep,ev,re,r,rp) 
...
function c515958932.sumpenop(e,tp,eg,ep,ev,re,r,rp,c,sg,og)
	...
	e4:SetCondition(c515958932.pensumcon)
	e4:SetTarget(c515958932.pensumtg)
