...
function c210242592.initial_effect(c)
	--link summon
	...
	e0:SetCondition(c210242592.lkcon)
	e0:SetOperation(c210242592.lkop)
	...
	e3:SetTarget(c210242592.tgtg)
	e3:SetValue(c210242592.indval)
	c:RegisterEffect(e3)
end
function c210242592.tgtg(e,c)
	return e:GetHandler():GetLinkedGroup():IsContains(c)
end
function c210242592.indval(e,c)
