...
function c240100570.initial_effect(c)
	...
	e3:SetOperation(function(e) local c=e:GetHandler() local rc=re:GetHandler() if c:GetFlagEffect(240100570)==0 and re:IsActiveType(TYPE_MONSTER) and rc:IsSetCard(0xbb2) and c:GetLinkedGroup():IsContains(rc) then c:RegisterFlagEffect(240100570,RESET_EVENT+0x1fe0000,0,1) end end)
	c:RegisterEffect(e3)
end
...
function c240100570.val(e)
	return Duel.GetMatchingGroupCount(c240100570.atkfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,nil)*100
end
...
function c240100570.op(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(240100570)==0 or g:GetCount()==0
