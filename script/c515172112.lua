...
function c515172112.initial_effect(c)
	--Normal monster
	...
	e3:SetCondition(c515172112.spcon)
	e3:SetTarget(c515172112.sptg)
	e3:SetOperation(c515172112.spop)
	c:RegisterEffect(e3)
	--lv change
	...
	e4:SetCountLimit(1)
	e4:SetTarget(c515172112.lvtg)
	e4:SetOperation(c515172112.lvop)
	c:RegisterEffect(e4)
end
function c515172112.lvtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c515172112.lvfilter(c,e)
...
function c515172112.spcfilter(c,tp)
	return c:IsSetCard(0x3b) and c:IsReason(REASON_EFFECT+REASON_BATTLE)
end
function c515172112.spcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c515172112.spcfilter,1,nil,tp)
end
function c515172112.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) end
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,e:GetHandler(),1,0,0)
end
function c515172112.spop(e,tp,eg,ep,ev,re,r,rp)
