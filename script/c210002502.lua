...
function c210002502.atg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if c210002502.condition(e,tp,eg,ep,ev,re,r,rp,0)
		and c210002502.cost(e,tp,eg,ep,ev,re,r,rp,0) 
	...
	elseif c210002502.condition2(e,tp,eg,ep,ev,re,r,rp,0)
		and c210002502.cost2(e,tp,eg,ep,ev,re,r,rp,0) 
		and c210002502.target2(e,tp,eg,ep,ev,re,r,rp,0)
		and Duel.SelectYesNo(tp,94) then
		c210002502.condition2(e,tp,eg,ep,ev,re,r,rp,1)
