...
--AlphaKretin
function c515310154.initial_effect(c)
	--xyz summon
	...
	e1:SetValue(c515310154.efilter)
	c:RegisterEffect(e1)
	--todeck
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c515310154.tdcon)
	e2:SetCost(c515310154.tdcost)
	e2:SetTarget(c515310154.tdtg)
	e2:SetOperation(c515310154.tdop)
	c:RegisterEffect(e2)
end
function c515310154.efilter(e,te)
	return te:IsActiveType(TYPE_MONSTER) and te:GetOwner()~=e:GetOwner()
end
function c515310154.tdcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetOverlayGroup():IsExists(Card.IsCode,1,nil,82633039)
end
function c515310154.tdcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
end
function c515310154.tdtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c515310154.tdop(e,tp,eg,ep,ev,re,r,rp)
