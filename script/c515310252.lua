--Unexpected Daiagram
--AlphaKretin
function c515310252.initial_effect(c)
	--Activate
	...
	e4:SetTarget(c515310252.indtg)
	e4:SetValue(c515310252.indct)
	c:RegisterEffect(e4)
	--destroy
...
function c515310252.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 and Duel.Destroy(g,REASON_EFFECT)~=0 then
		...
		local g=Duel.SelectMatchingCard(tp,c515310252.thfilter,tp,LOCATION_DECK,0,1,1,nil)
