--Unexpected Daice
--AlphaKretin
function c210310254.initial_effect(c)
	--lv change
	...
	e1:SetTarget(c210310254.tg)
	e1:SetOperation(c210310254.op)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c210310254.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c210310254.filter,tp,LOCATION_MZONE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c210310254.filter,tp,LOCATION_MZONE,0,1,1,nil)
	local t={}
	local i=1
	local p=1
...
function c210310254.op(e,tp,eg,ep,ev,re,r,rp)
