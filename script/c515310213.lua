...
function c515310213.filter(c)
	return c:IsFaceup() and not (c:GetLevel()==0) and Duel.IsPlayerCanSpecialSummonMonster(tp,515310214,0,0x4011,c:GetAttack(),c:GetDefense(),c:GetLevel(),c:GetRace(),c:GetAttribute())
end
function c515310213.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g=Duel.SelectTarget(tp,c515310213.filter,tp,0,LOCATION_MZONE,1,1,nil,e,tp)
