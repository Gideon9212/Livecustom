function c515555501.initial_effect(c)
	--activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_DRAW+CATEGORY_SEARCH)
    e1:SetCost(c515555501.cost)
	e1:SetTarget(c515555501.target)
	e1:SetOperation(c515555501.activate)
	c:RegisterEffect(e1)
end
function c515555501.cfilter(c)
